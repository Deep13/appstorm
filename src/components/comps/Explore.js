                    ...
                    filteredData.map((val, index) => {
                        return <div >
                            <div className='zoom-container'>
                                ...
                                }} style={{ boxShadow: '0px -20px 20px 5px inset', backgroundImage: `url(${val.thumbnail})`, height: 300, width: 300, borderRadius: 20, cursor: 'pointer', padding: '20px 20px 10px 20px', display: 'flex', alignItems: 'end' }}>
